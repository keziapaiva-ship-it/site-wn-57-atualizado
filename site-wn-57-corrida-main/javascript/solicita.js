  ...
  container.innerHTML = `
        ...
        <div class="destino-conteudo">
            ...
            <div class="mapa-estado">
                ...
                <div class="mapa-rua rua1"></div>
                <div class="mapa-rua rua2"></div>
                <div class="mapa-rua rua3"></div>
                <div class="mapa-rua rua4"></div>

                <div class="mapa-pin pin1">
                    📍
                </div>

                <div class="mapa-pin pin2">
                    📍
                </div>

                <div class="mapa-pin pin3">
                    📍
                </div>

                <div class="mapa-pin pin4">
                    📍
                </div>
            ...
            <div
                ...
                <div class="destaque-card">
                    ...
                    <img
                        ...
                        src="/site-de-corrida-wn-57-main/site-wn-57-corrida-main/img/Gemini_Generated_Image_98smgp98smgp98sm.jpg"
                        alt="Destino">
                ...
                <div class="destaque-card">
                    ...
                    <img
                        class="destaque-imagem"
                        src="/site-de-corrida-wn-57-main/site-wn-57-corrida-main/img/ChatGPT Image 9 de set. de 2026, 15_31_56.png"
                        alt="WN57">
...
function mostrarCategoria(categoria) {
  ...
  const lista =
    document.getElementById("listaDestinos");

  if (!container || !lista) return;


  const codigo =
    container.dataset.estado || "PR";

  const estado =
    estadosBrasil[codigo];
  ...
  dados.forEach(function (item) {
    ...
    const botao =
      div.querySelector(".destino-iniciar");
